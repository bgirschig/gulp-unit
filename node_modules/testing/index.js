...
if(!isBrowser) var colors = require('colors');
...
(function(){
	...
	function logResults(groupName){
		...
		if(!isBrowser){
			...
			var results = document.getElementById('testingResults');
			results.innerHTML += "<h3>"+groupName+"</h3>";
			for (var i = 0; i < Testing.passed.length; i++){
				results.innerHTML += "<span style='color:green'>&#10004; Test passed: "+Testing.passed[i]+"</span><br>";
			}
			for (var i = 0; i < Testing.failed.length; i++){
				results.innerHTML += "<span style='color:red'>&#10006; Test failed: "+Testing.failed[i]+"</span><br>";
			}
		}
	}
